...
On a laptop with 32 GB RAM and an Intel Core i7-11850H 2.5 GHz processor, resampling 116,156 plots took less than 4 minutes. As a result, we obtained a `data.table` with PlotObservationIDs and coordinates for **61,336 plots** that are either more than 1,000 m apart or less similar than 0.6 within each environmental stratum.
