...
Now, we need two files: 1) header data with vegetation-plot (relevé) ID and geographical coordinates, and 2) species data in long format with relevé ID, taxon names and their covers.
